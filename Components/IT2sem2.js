...
export default function IT2sem2() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('ITAlgorithms')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('ITIntjava')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() =>  navigation.navigate('ITDatabase')}
            >
              <Text style={styles.schoolText}>ICT 271 Database</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('ITNetworking')}
            >
              <Text style={styles.schoolText}>ICT 242 Networking & Communication</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('ITOperating')}
            >
