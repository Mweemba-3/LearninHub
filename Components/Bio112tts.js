...
const CloudinaryDownloader18 = ({ contextId }) => {
  ...
  const cloudinaryUris = [
   "https://res.cloudinary.com/dpxvpbtie/image/upload/v1738052617/Tutorial Sheet 1- Cell division.pdf ",
    " https://res.cloudinary.com/dpxvpbtie/image/upload/v1737587377/bio/bio112/TUTORIAL SHEET 2-DNA REPLICATION%2C TRANSCRIPTION AND TRANSLATION.pdf",
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1737587377/bio/bio112/tutorial%20sheets/TUTORIAL SHEET 3-GENE EXPRESSION AND MUTATIONS.pdf ",
...
export default CloudinaryDownloader18;