...
export default function Beng2Civilsem1() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('CivilDrawing')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('Civilmaterials')}
            >
              <Text style={styles.schoolText}>Engineering Materials</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('Civilmathermatics')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('Civilelectronics')}
            >
              <Text style={styles.schoolText}>Eletrical and Electronics</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('Civilstatics')}
            >
