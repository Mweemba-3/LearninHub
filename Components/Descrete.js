...
export default function CSDescrete() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('Descretelect')}
            >
          
              <Text style={styles.schoolText}>Lectures, Notes and Prescribed Book</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('Descretetest')}
            >
