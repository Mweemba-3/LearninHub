...
export default function Bio112() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('bio112lcs')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('bio112tts')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() =>  navigation.navigate('bio112etq')}
            >
              <Text style={styles.schoolText}>Exams, Test's and Quizzes</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('bio112rb')}
            >
