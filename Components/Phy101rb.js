...
const CloudinaryDownloader4= ({ contextId }) => {
  ...
  const cloudinaryUris = [
   "https://res.cloudinary.com/dpxvpbtie/image/upload/v1737408759/College Physics Questions and answers.pdf",
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1738068222/phy101/lectures/Serway Modern Physics.pdf",
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1738068198/phy101/lectures/Phy101 Course Outline.pdf"
    //more data
 ];
...
export default CloudinaryDownloader4;