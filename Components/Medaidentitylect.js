...
const CloudinaryDownloader87= ({ contextId }) => {
  ...
  const cloudinaryUris = [
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1739270287/BCS 252: MEDIA AND IDENTITY.pdf ", 
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1739271336/tBCS 252: MEDIA AND IDENTITY.pdf ",
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1739271340/THEORIES and MODELS OF COMMUNICATION.pdf ",
    //data
 ];
...
export default CloudinaryDownloader87;