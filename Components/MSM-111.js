...
export default function MSM111() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('msm111lcs')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('msm111tts')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() =>  navigation.navigate('msm111etq')}
            >
              <Text style={styles.schoolText}>Exam, Test's and Quizzes</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('msm111rb')}
            >
