...
export default function IT2sem1() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('ITBMG')}
            >
            <Text style={styles.schoolText}>BMG</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('ITComputerArch')}
            >
