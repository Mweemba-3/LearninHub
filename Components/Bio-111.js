...
export default function Bio111() {
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('bio111lcs')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('bio111tts')}
            >
            ...
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() =>  navigation.navigate('bio111etq')}
            >
              <Text style={styles.schoolText}>Exams, Test's and Quizzes</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('bio111rb')}
            >
