...
const CloudinaryDownloader19 = ({ contextId }) => {
  ...
  const cloudinaryUris = [
    "https://res.cloudinary.com/dpxvpbtie/image/upload/v1738067696/bio/bio112/test/Bio 112: Final exam 2018.pdf ",
    //more data
  ];
...
export default CloudinaryDownloader19;