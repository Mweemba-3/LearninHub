...
export default function BsAdminandmarksem1() {
       ...
       <ImageBackground
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.schoolsContainer}>
            ...
            >
              <Text style={styles.schoolText}>Course One</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.schoolButton}
              onPress={() => navigation.navigate('')}
            >
              ...
              <Text style={styles.schoolText}>Course Two</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('')}
            >
              <Text style={styles.schoolText}>Course Three</Text>
            </TouchableOpacity>
